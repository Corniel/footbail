...
public sealed class Pitch
{
    ...
    public static readonly Pitch FIFA = new(touchLine: 105, goalLine: 68, goal: 7.32);

    /// <summary>Gets the pitch specification for Futsal (with bouncing lines).</summary>
    public static readonly Pitch Futsal = new(touchLine: 40, goalLine: 22.5, goal: 3, bouncingLines: true);
